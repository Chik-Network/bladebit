...
public:
    ...
    ProofFetchResult FetchQualityXsForP7Entry( uint64 t6Index,const byte challenge[BB_CHIK_CHALLENGE_SIZE], uint64& outX1, uint64& outX2 );
    ProofFetchResult FetchQualityForP7Entry( uint64 t6Index, const byte challenge[BB_CHIK_CHALLENGE_SIZE], byte outQuality[BB_CHIK_QUALITY_SIZE] );
