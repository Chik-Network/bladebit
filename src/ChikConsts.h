...
///
/// These are extracted from chikpos.
/// Comments are taken directly from chikpos unless otherwise specified.
///
...
// @Harold: Not that we changed this from 1-indexing in the chikpos implementation
...
#define BB_CHIK_CHALLENGE_SIZE 32
#define BB_CHIK_QUALITY_SIZE   32

#define BB_CHIK_K_MAX_VALUE    50
